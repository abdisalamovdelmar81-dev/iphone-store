...
Версия 1: роли админа и клиента, каталог, корзина, заказ с адресом и уведомление админу.
...
```text
/add iPhone 16 Pro 256 ГБ | 5 | 119990
```

Или нажми `Добавить товар` и бот спросит: имя, количество и цену.
