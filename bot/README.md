...
Версия 2: роли админа и клиента, каталог, корзина, заказ с адресом, уведомление админу, поиск, цвет и фото товара.
...
```text
/add iPhone 16 Pro 256 ГБ | 5 | 119990 | Ультрамарин
```

После быстрой команды бот попросит отправить фото товара.

Или нажми `Добавить товар` и бот спросит: имя, количество, цену, цвет и фото.
